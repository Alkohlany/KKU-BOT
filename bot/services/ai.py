...
def generate_news_analysis(title: str, content: str) -> dict:
    prompt = f"""أنت طالب سعودي يدرس في جامعة الملك خالد. حلل خبر الجامعة هذا باللهجة السعودية.

⚠️ تعليمات مهمة:
- ركّز على الموضوع الرئيسي للخبر فقط
- لا تذكر روابط أو هاشتاقات أو إعلانات
- الكلمات المفتاحية تكون كلمات وحدها فقط (بدون جمل)
- الأسئلة تكون باللهجة السعودية فقط
- لا تستخدم علامات مثل # أو روابط
